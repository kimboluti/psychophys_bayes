% Psychometric Function Group Odd
...
NN(:,:,1) = dlmread('datafiles/TwoToneDif_dataFP1_n.txt','\t');
NN(:,:,2) = dlmread('datafiles/TwoToneDif_dataFP2_n.txt','\t');
NN(:,:,3) = dlmread('datafiles/TwoToneDif_dataFP3_n.txt','\t');
NN(:,:,4) = dlmread('datafiles/TwoToneDif_dataFP4_n.txt','\t');

% r = dlmread('FP1_data_r.txt','\t'); %count of "longer" resps at each x cell
RR = zeros(nsubjs,9,nCon);
RR(:,:,1) = dlmread('datafiles/TwoToneDif_dataFP1_r.txt','\t');
RR(:,:,2) = dlmread('datafiles/TwoToneDif_dataFP2_r.txt','\t');
RR(:,:,3) = dlmread('datafiles/TwoToneDif_dataFP3_r.txt','\t');
RR(:,:,4) = dlmread('datafiles/TwoToneDif_dataFP4_r.txt','\t');

% x = dlmread('FP1_data_x.txt','\t'); %test durations
XX = zeros(nsubjs,9,nCon);
XX(:,:,1) = dlmread('datafiles/TwoToneDif_dataFP_x.txt','\t');
XX(:,:,2) = dlmread('datafiles/TwoToneDif_dataFP_x.txt','\t');
XX(:,:,3) = dlmread('datafiles/TwoToneDif_dataFP_x.txt','\t');
XX(:,:,4) = dlmread('datafiles/TwoToneDif_dataFP_x.txt','\t');

% rprop = dlmread('FP1_data_rprop.txt','\t'); %proportion of "longer" resps at each x level
RPR = zeros(nsubjs,9,nCon);
RPR(:,:,1) = dlmread('datafiles/TwoToneDif_dataFP1_rprop.txt','\t');
RPR(:,:,2) = dlmread('datafiles/TwoToneDif_dataFP2_rprop.txt','\t');
RPR(:,:,3) = dlmread('datafiles/TwoToneDif_dataFP3_rprop.txt','\t');
RPR(:,:,4) = dlmread('datafiles/TwoToneDif_dataFP4_rprop.txt','\t');
